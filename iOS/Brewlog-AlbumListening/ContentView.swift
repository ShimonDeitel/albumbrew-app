...
struct ContentView: View {
    ...
    @State private var editingItem: Album?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Brewlog - Album Listening")
            .toolbar {
    ...
    @ViewBuilder
    private func row(for item: Album) -> some View {
...
struct EditorSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView {
                    ...
                    TextField("Artist", text: $draft.artist)
                        .textFieldStyle(.roundedBorder)
                        .accessibilityIdentifier("field_artist")
                    TextField("Year", value: $draft.year, formatter: NumberFormatter())
            ...
            .navigationTitle(isNew ? "Add Album" : "Edit Album")
            .toolbar {
